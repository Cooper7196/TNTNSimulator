...
- [x] Task: Implement rendering for the 2D robot model on the screen.
- [x] Task: Implement rendering for the 2D VexU field.
- [x] Task: Integrate game controller input for manual robot control.
