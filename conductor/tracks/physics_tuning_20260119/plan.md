...
- [ ] Task: Add on-screen debug text rendering to the `Renderer` class to show velocity and position.
- [ ] Task: Verify the implementation of the state-space discretization and update logic.
...
- [ ] Task: Tune the `Inertia` parameter to make turning less "floaty".
- [ ] Task: Tune the `Mass` parameter.
- [ ] Task: Adjust friction coefficients to achieve realistic stopping.
